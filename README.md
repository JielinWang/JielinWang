...
<p align="center">My name is Jielin Wang, a software develover and web developer from China 🇨🇳 </p>
<p"> Economics major turned frontend web developer with a keen eye for responsive design, proficient in HTML, CSS, and JavaScript, and possessing a solid understanding of React, Node.js, and MongoDB. I love working on solving different problems and an enthusiast for programming, my goal is to create innovative applications that could make a positive impact on society and solve real-world problems. Speak English (Professional), Mandarin (Native) and Korean (Fluent). </p>

## A bit more about me:

- 😄 Pronouns: 🇬🇧 She/her - 🇺🇲 Jielin 
